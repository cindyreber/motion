   ...
   <ProfileWrapper>
       <ProfileDetail>
        <CardWrapper>
                ...
                <button class="uploadImageButton"> <i class="fas fa-upload"></i> Upload</button>
                <button class="uploadImageButton"><i class="fas fa-trash-alt"></i> Remove</button>
       ...
       <FormDetails>
           ...
           <ThingLikeTag>
            <p>Things i like</p>
            <AddTag>
             <span>Cooking <i class="fas fa-times"></i></span>
             <span>Cooking <i class="fas fa-times"></i></span>
             <span>Cooking <i class="fas fa-times"></i></span>
             <span>Cooking <i class="fas fa-times"></i></span>
            </AddTag>
            <TagInput>
                <input class="tagInputField" type="text" name="" placeholder="Type something....." />
